...
namespace AppBundle\Entity\Offerpage;
...
/**
 * AppBundle\Entity\Offerpage\OfferPage
 * @ORM\Table(name="offerpage")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Offerpage\OfferpageRepository")
 */
class OfferPage{

	
	/**
	 * @ORM\OneToMany(targetEntity="AppBundle\Entity\Offerpage\Offer\Offer", mappedBy="offerpage")
	 */
	private $offers;
	...
	public function hasOfferHeader()
	{
		return file_exists(__DIR__.'/../../../../web/images/headers/offers.jpg');
	}
